...
const IdleScreen: React.FC<IdleScreenProps> = ({ send, showContinue }) => {
      ...
      {showContinue && (
        <>
          ...
          <button
            ...
            className="w-full flex items-center justify-center bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-4 rounded-lg shadow-lg transition duration-300 ease-in-out transform hover:scale-105"
          >
